...
<html>
  ...
  <body>
    ...
    <?php echo form_open('/createPost');?>
    <!-- <form action="/codeigniter/createPost"> -->
    <fieldset>
      <legend>Create a new Memo :</legend>
      <div class="form-group">
        <label>Title</label>
        <input type="text" class="form-control" name="title" value="<?php echo set_value('title'); ?>" aria-describedby="emailHelp" placeholder="Enter Memo Title">
        <small id="emailHelp" class="form-text text-muted">This is your memories title.</small>
      </div>
      <div class="form-group">
        <label>Slug</label>
        <input type="text" class="form-control" name="slug" value="<?php echo set_value('slug'); ?>" aria-describedby="emailHelp" placeholder="Enter Slug">
        <small id="emailHelp" class="form-text text-muted">This is your URL name(/slug).</small>
      </div>
      <div class="form-group">
        <label>Date</label>
        <input type="date" class="form-control" name="date" value="<?php echo set_value('date'); ?>" aria-describedby="emailHelp" placeholder="Enter Date">
      </div>
      <div class="form-group">
        <label>Color select</label>
        <select class="form-control" name="type">
          <option class="table-active" value="table-active">選擇標記顏色</option>
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" name="ps" rows="3"><?php echo set_value('ps'); ?></textarea>
      </div>
